...
<section class="content">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                @if (( Auth::user()->role == "2"))
                <a href="{{ route('jobseeker.testimonial.create') }}" class="btn btn-primary">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-sm" id="testimonial-table">
                    <thead>
                        <th>S.No</th>
                        <th>Title</th>
                        <th>Status</th>
...
<script>
    var oTable = $('#testimonial-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{!! route('testimonial.datatables') !!}",
            data: function(d) {
                d.status = $('#status').val();
                d.title = $('#title').val();
            }
