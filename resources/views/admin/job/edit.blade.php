...
<form action="{{ route('admin.job.update', $listings->id) }}" method="POST" enctype="multipart/form-data">
    {{ method_field('PUT') }}
    @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="rate" value="{{ old('rate', $listings->rate) }}" id="rate" class="form-control {{ $errors->has('rate') ? 'is-invalid' : '' }}" placeholder="Rate" autocomplete="off" />
                            @if($errors->has('rate'))
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="work_days" value="{{ old('work_days', $listings->work_days) }}" id="work_days" class="form-control {{ $errors->has('work_days') ? 'is-invalid' : '' }}" placeholder="Work Days" autocomplete="off" />
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class='input-group date'>
                                <input type="text" name="from_date" class="form-control" id="datepicker1" placeholder="YYYY-MM-DD" value="{{ old('from_date', $listings->from_date) }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>To Date : </label>
                            <div class='input-group date'>
                                <input type="text" name="to_date" class="form-control" id="datepicker2" placeholder="YYYY-MM-DD" value="{{ old('to_date', $listings->to_date) }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="address" id="address" rows="3" class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" placeholder="Address">{{ old('address', $listings->address) }}</textarea>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" rows="3" class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" placeholder="Description">{{ old('description', $listings->description) }}</textarea>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="practice_offer" id="practice_offer" rows="3" class="form-control ckeditor {{ $errors->has('practice_offer') ? 'is-invalid' : '' }}" placeholder="Description">{{ old('practice_offer', $listings->practice_offer) }}</textarea>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="essential_criteria" id="essential_criteria" rows="3" class="form-control ckeditor {{ $errors->has('essential_criteria') ? 'is-invalid' : '' }}" placeholder="Essential Criteria">{{ old('essential_criteria',$listings->essential_criteria) }}</textarea>
