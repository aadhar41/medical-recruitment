            ...
            <div class="row col-md-12">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" placeholder="Job Category" class="form-control" autocomplete="off" />
                    </div>
                </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-sm" id="jobcategory-table">
                    <thead>
                        <th>S.No</th>
                        <th>Job Category</th>
                        <th>Status</th>
...
<script>
    var oTable = $('#jobcategory-table').DataTable({
        processing: true,
        "searching": true,
        serverSide: true,
        ajax: {
            url: "{!! route('jobcategory.datatables') !!}",
            data: function(d) {
                d.status = $('#status').val();
                d.name = $('#name').val();
            }
