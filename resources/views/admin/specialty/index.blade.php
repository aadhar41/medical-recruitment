            ...
            <div class="row col-md-12">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="specialty" id="specialty" placeholder="Speciality" class="form-control" autocomplete="off" />
                    </div>
                </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-sm" id="specialty-table">
                    <thead>
                        <th>S.No</th>
                        <th>Speciality</th>
                        <th>Status</th>
...
<script>
    var oTable = $('#specialty-table').DataTable({
        processing: true,
        "searching": true,
        serverSide: true,
        ajax: {
            url: "{!! route('specialty.datatables') !!}",
            data: function(d) {
                d.status = $('#status').val();
