            ...
            <div class="col-xl-12 col-lg-12">
                <div class="joblisting" id="js-joblisting">
                    <div class="tab-content" id="myTabContent">
                        @if(count($jobarchives) > 0 )

                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            @foreach($jobarchives as $jobarchive )
                            ...
                            <div class="card">
                                ...
                                <span class="jobtype">
                                    {!! $jobarchive->associatedJobtype->type !!}
                                </span>
                                <ul class="joblabels">
                                    <li>
                                    ...
                                    <li>
                                        {!! $jobarchive->fee_offered !!}
                                    </li>
                                    <li>
                                        <i class="far fa-clock"></i>
                                        {!! $jobarchive->open_days !!}
                                    </li>
                                ...
                                <div class="bottombar">
                                    <a href="{{route('jobarchivedetails', [$jobarchive->slug])}}">
                                        <button type="button" class="btn" style="background-color:#06396c; color:#fff;">View Details</button>
                                    </a>
                                </div>
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <div class="card">
                                ...
                                <span class="jobtype">
                                    {!! $jobarchive->associatedJobtype->jobtype !!}--
                                </span>
                                <ul class="joblabels">
                                    <li>
                                        <i class="fas fa-map-marker-alt"></i>
                                        {!! $jobarchive->jobcategory->name !!}
                                    </li>
                                    <li>
                        ...
                        {{ $jobarchives->links("vendor.pagination.bootstrap-4") }}
